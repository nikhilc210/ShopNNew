    ...
    <View style={{flex: 1, backgroundColor: secondaryColor}}>
      ...
      <ScrollView
        contentContainerStyle={{
          ...
          marginTop: 16,
          flex: 1,
          borderTopLeftRadius: sheetRoundness,
          borderTopRightRadius: sheetRoundness,
          paddingTop: 32,
        }}>
        <View key="Categories" style={{width: '100%', flex: 1}}>
          <View style={{width: '100%', marginStart: 12}}>
            <Text style={[globalStyles.boldText]}>Categories</Text>
          </View>
          <View
            style={{
          ...
          <View
            ...
            <Text style={[globalStyles.boldText]}>Sort</Text>
          </View>
...
export default connect(mapStateToProps)(FilterSheet);
